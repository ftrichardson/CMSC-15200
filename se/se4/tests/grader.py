...
RUBRIC = [
          ("Exercise 1: Find denomination", "find_amount_of_denomination", 25),
          ("Exercise 1: Make change", "make_change", 25),
          ("Exercise 2: Repeat data in a struct", "repeat", 25),
          ("Exercise 3: Make negative of an image", "create_negative", 25)  
         ]
