...
RUBRIC = [
          ("Exercise 1: Compute Payoff Amount", "compute_payoff_amount", 25.0),
          ("Exercise 2: Compute Leonardo Number", "compute_leonardo", 25.0),
          ("Exercise 3: Bakhshali Recursive", "bakhshali_recursive", 25.0),
          ("Exercise 4: Bakhshali Iterative", "bakhshali_iterative", 25.0)    
         ]
