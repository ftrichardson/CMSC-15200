...
RUBRIC = [
          ("Exercise 1: Find minimum and maximum", "find_min_max", 20.0),
          ("Exercise 2: Make string of stars", "make_star_string", 20.0),
          ("Exercise 3: Make histogram", "make_histogram", 20.0),
          ("Exercise 4: Make array of strings of stars", "make_star_array", 20.0),
          ("Exercise 5: Make visualization", "make_histogram_visualization", 20.0)   
         ]
