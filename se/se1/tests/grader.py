...
RUBRIC = [
          ("Exercise 1: Vector Length", "vec_length", 20.0),
          ("Exercise 2: Compute Division Fraction", "compute_div_fraction", 20.0),
          ("Exercise 3: Congruent Mod N", "is_congruent_mod_n", 20.0),
          ("Exercise 4: Is Out of Range", "is_out_of_range", 20.0),
          ("Exercise 5: Clip", "clip", 20.0)
         ]
