...
RUBRIC = [
          ("Part 2: Add a task", "tm_add_task", 10),
          ("Part 2: Is empty", "tm_is_empty", 5),
          ("Part 2: Remove the most urgent task", "tm_remove_most_urgent_task", 10),
          ("Part 2: Mixed", "tm_mixed", 10),    
          ("Part 3: Scheduler", "simulate_cores", 30)
         ]
